...
//         )}
//       </div>
//       <div className="main-page-detail-achievement-container">
//         <span>달성률✨</span>
...
const Main = () => {
  ...
  // Calculate the achievement rate for the selected day
  const selectedDayEvents = dayEvents.find((day) => day.day === selectedDay);
  const achievementRate = selectedDayEvents
    ? selectedDayEvents.completionPercentage
    : 0;
    ...
    <div className="main-page-container">
      ...
      {/* <div className="main-page-detail-achievement-container">
        <div className="achievement-title-container">
          <span className="achievement-title">달성률✨</span>
        </div>
        ...
        <span className="achievement-percentage">{achievementRate}%</span>
      </div> */}
    </div>
  );
};
